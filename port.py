...
if page == "Home":
    ...
    name = st.text_input("Your Name", "Murekeyisoni Bennitha")
    ...
    if st.button("🔍 Deep Me"):
        ...
        st.write("- Full Name: Murekeyisoni Bennitha")
        st.write("- Date of Birth: 20/12/2003")
        st.write("- Nationality: Rwandan")
        st.write("- Gender: Female")
        st.write("- Marital Status: Single")
        st.write("- Email: benithamurekeyisoni@gmail.com")
...
# Projects Page
    ...
    with st.expander("🌊 AI-Based Loan Evaluation System (Final Year Project)"):
        ...
        st.write("[GitHub Repository](https://github.com/Bennitha/loan-evaluation)")
...
# Contact Page
    ...
    st.write("📧 Email: benithamurekeyisoni@gmail.com")
    st.write("📱 Phone: 0786910365")
    st.write("🔗 [LinkedIn](linkedin.com/in/Murekeyisoni-Bennitha-404063265)")
    st.write("🔗 [GitHub](https://github.com/Bennitha)")

# Testimonials Page
elif page == "Testimonials":
    st.title("🗣 Testimonials")
    st.write("What others say about me.")
    st.write("-Bennitha' is an excellent problem solver and has great coding skills!' - Dr. Theodore")
